  ...
  const waterOffers = [
    {
      ...
      img: <WaterOne clasName="offer-sec-img" />,
    ...
    },
    {
      ...
      img: <WaterTwo clasName="offer-sec-img" />,
    ...
    },
    {
      ...
      img: <WaterThree clasName="offer-sec-img" />,
    ...
    },
    {
      ...
      img: <WaterFour clasName="offer-sec-img" />,
    ...
    <section className="offer">
      <div className="offer-holder sections-holder">
        <div className="offer-text-holder">
          <h2 className="offer-title">Ponuda voda</h2>
